...
if __name__ == '__main__':
    ...
    for filename in sub_files:
        off_file = os.path.join(obj_path, filename, filename+'_lower_sim.off')
        re_file = os.path.join(obj_path, filename, filename + '_lower_sim_re.txt')
    ...
    # off_file = 'F:/dataset/Teeth3DS/data/upper/00OMSZGW/00OMSZGW_upper_sim.off'
    # txt_file = 'F:/dataset/Teeth3DS/data/upper/00OMSZGW/00OMSZGW_upper_sim_re.txt'
    # mesh = trimesh.load_mesh(off_file)
